...
/** ***************************************************************** How to
  * Organize Functionality There are several different ways to implement and
  * organize behaviors:
  *
  * Define your functions in `companion` objects Use a `modular` programming
  * style Use a `functional objects` approach Define the functionality in
  * `extension` methods
  */
