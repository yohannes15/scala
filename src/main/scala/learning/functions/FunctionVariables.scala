...
/** **********************************************************
  *
  * Function Variables -------------------------------- An anonymous function
  * (function literal) can be assigned to a variable to create a function
  * variable.
  *
  * val variableName = (parameter: Type) => body
  *
  * The REPL shows the inferred type: val double: Int => Int = ... meaning it
  * takes a single Int and returns an Int.
  *
