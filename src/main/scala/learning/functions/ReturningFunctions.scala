...
/** **********************************************************
  ...
  * ----------------------------------------------------------- Writing a method
  * that returns a function is similar to everything you've seen. For example,
  * imagine that you want to write a greet method that returns a function.
  *
  * Once again we start with a problem statement:
  *
  * `I want to create a greet method that returns a function. That function will
  * take a string parameter and print it using println. To simplify this first
  * example, greet won't take any input parameters; it will just build a
  ...
  * `def greet()`
  *
  *   2. It will return a function that (a) takes a String parameter and (b)
  *      prints it:
  *
  ...
  *
  * def greet(): String => Unit = (name: String) => println(s"Hello, $name")
  *
  *   4. We can also pass in a greeting to make it more useful:
  *
  * def greet(theGreeting: String): String => Unit = (name: String) =>
  * println(s"$theGreeting, $name")
  *
...
/** ***********************************************************
  ...
  *   - You can pass them into the dozens of HOFs on the collections classes
  *     (map, filter, etc.)
  *   - With these small code fragments and powerful HOFs, you create a lot of
  *     functionality with just a little code
  *
  * After looking at anonymous functions and HOFs, you saw:
  *   - Function variables are simply anonymous functions that have been bound
  *     to a variable
  *
  * After seeing how to be a consumer of HOFs, you then saw how to be a creator
  * of HOFs:
  *   - How to write methods that take functions as input parameters
  *   - How to return a function from a method
  *
  * A beneficial side effect of this chapter is that you saw many examples of
  * how to declare type signatures for functions. The same syntax is used to
  * define function parameters, anonymous functions, and function variables —
  * and it also makes it easier to read the Scaladoc for higher-order functions
  * like map, filter, and others.
  */
