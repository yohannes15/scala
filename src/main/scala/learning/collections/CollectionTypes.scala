...
/** ********************************************************************
  ...
  *
  * In general, except for the difference that (a) Vector is indexed and List is
  * not, and (b) List has the :: method,
  *
  * the two types work the same, so we’ll quickly run through examples.
  *
  * Because Vector is immutable, you can’t add new elements to it. Instead, you
  * create a new sequence by appending or prepending elements to an existing
  * Vector
  *
  * In addition to fast random access and updates, Vector provides fast append
  * and prepend times.
  */
...
/** ********************************************************************
  ...
  * Array
  * -----------------------------------------------------------------------
  * Scala Array elements are mutable, indexed, and have a fixed size. If you
  * need a resizable sequence, consider using ArrayBuffer instead.
  */
...
/** ********************************************************************
  *
  * Maps -----------------------------------------------------------------------
  * An iterable collection that consists of pairs of keys and values. has both
  * mutable and immutable Map types
  *
  * Scala has many more specialized Map types, including CollisionProofHashMap,
  * HashMap, LinkedHashMap, ListMap, SortedMap, TreeMap, WeakHashMap, and more.
  *
...
def mapExample() =
  ...
  val updatedVals =
    vals.updated(3, "THREE!") // Map(1 -> one, 2 -> two, 3 -> THREE!)
  val updatedValsAnotherWay =
    vals + (2 -> "TWO....") // Map(1 -> one, 2 -> TWO..., 3 -> three)
  println(updatedVals)
...
/** ********************************************************************
  *
  * Sets -----------------------------------------------------------------------
  * An iterable collection with no duplicate elements. Order of iteration of the
...
/** ********************************************************************
  ...
  *
  * This section demonstrates **Range** (`to` / `until` / `by`, and collection
  * factories).
  */
...
/** ******************************************************************** SUMMARY
  * ----------------------------------------------------------------------- When
  * you need more information about specialized collections, see the following
  * resources:
  *
  ...
  *
  * When you need to see more details about the collections types shown in this
  * chapter, see their Scaladoc pages:
  *
  * List -
  ...
  * Range -
  * https://www.scala-lang.org/api/current/scala/collection/immutable/Range.html
  *
  ...
  * Set -
  * https://www.scala-lang.org/api/current/scala/collection/immutable/Set.html
  *
  * and the mutable Map and Set:
  *
  * Map -
  * https://www.scala-lang.org/api/current/scala/collection/mutable/Map.html Set -
