...
`Null`:
    ...
    - usage of keyword null is considered bad practice and shouldn't be used. Only used for interoperability
...
-> Value types can be cast in the following way: `src/main/scala/learning/static/type-casting-diagram.svg`.
   Byte -> Short -> Int -> Long -> Float -> Double.
                    ...
                    |||
                    Char
-> You can only cast to a type if there is no loss of information, otherwise explicit cast needed
 */
