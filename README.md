...
**Structured capstone (optional but recommended):** **[`capstone/README.md`](capstone/README.md)** — *Capstone 1* checklist (**MiniCli** credit-band CLI is implemented there; optional AoC/Exercism reps; **boss** receipt parser) before opening Cats docs.
